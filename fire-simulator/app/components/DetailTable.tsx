                ...
                >
                  ...
                  <td className="px-4 py-2.5 text-center">
                    {d.isDrawdownPhase ? (
                      ...
                      <span className="px-2 py-0.5 rounded-full text-xs bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-400">
                        {t.phaseFreistellung}
                      </span>
                    ) : d.isCoastPhase ? (
                      <span className="px-2 py-0.5 rounded-full text-xs bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-400">
                        {t.phaseCoast}
                      </span>
                    ) : d.isLZKPhase ? (

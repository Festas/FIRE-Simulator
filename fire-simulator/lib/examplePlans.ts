...
/**
 * Helper to compute a FIRE number from monthly desired income and SWR.
 * Uses full income (no pension offset) because state pension only starts at Renteneintrittsalter.
 * The pension parameter is kept for backward compatibility but ignored in the calculation.
 */
function fireNumber(monthlyIncome: number, _pension: number, swr: number): number {
  return swr > 0 ? Math.round((monthlyIncome * 12) / (swr / 100)) : 0;
}
...
export const EXAMPLE_PLANS: ExamplePlan[] = [
  ...
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      zielvermoegen: fireNumber(2_000, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 22,
  ...
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      zielvermoegen: fireNumber(2_200, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 25,
  ...
  // -----------------------------------------------------------------------
  // 3. Median Earner — the classic FIRE path (~€100k gross)
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      inflation: 2.5,
      bavJaehrlich: 0,
      zielvermoegen: fireNumber(2_500, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 30,
  ...
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      zielvermoegen: fireNumber(4_500, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 32,
  ...
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      inflation: 2.5,
      bavJaehrlich: 8_000,
      zielvermoegen: fireNumber(5_000, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 28,
  ...
  // -----------------------------------------------------------------------
  {
    ...
    inputs: {
      ...
      inflation: 2.5,
      bavJaehrlich: 4_800,
      zielvermoegen: fireNumber(3_000, 0, 3.5),
      lzkJahre: 0,
      lzkRendite: 0,
      startYear: BASE_YEAR,
      currentAge: 40,
